...
const NOTIFICATIONS = [
	...
	},
	{
		...
		body: "Frequency Shift — budget too low",
		time: "Yesterday",
	},
	{
		id: "n3",
		...
		color: "text-blue-500",
		title: "EOI Submitted",
		body: "Vanguard Echo — pending review",
		time: "3 days ago",
	},
];
...
export default function TopNav({ showSearch = false }: TopNavProps) {
	...
	const activeLink = pathname.startsWith("/dashboard")
		? "platform"
	...
	const userInitial = auth?.displayName
