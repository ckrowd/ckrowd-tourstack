...
export const authLabel =
	"block text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--muted)] mb-2 transition-colors duration-300";
...
export const authTitle =
	"font-(family-name:--font-display) text-3xl leading-tight tracking-tight text-[var(--text)] transition-colors duration-300";
