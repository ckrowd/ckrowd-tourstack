		...
		<main className="flex-1 lg:ml-64 bg-surface p-6 md:p-10">
			...
			{eoisQuery.isLoading ? (
				...
				<div className="flex flex-col items-center justify-center py-24 text-on-surface-variant text-center">
					<span className="material-symbols-outlined text-5xl mb-4 text-on-surface-variant/30">
						notifications_off
					</span>
				...
				<div className="bg-surface rounded-2xl border border-outline-variant/30 shadow-sm overflow-hidden max-w-2xl">
						...
						{notifications.map((n) => (
							<li key={n.id}>
								...
								>
									...
									{n.date && (
										<span className="text-[11px] text-on-surface-variant/50 font-medium shrink-0 mt-0.5 whitespace-nowrap">
