...
export default function InsurancePage() {
	...
	const INSURANCE_PRODUCTS = [
		...
		{
			productId: INSURANCE_PRODUCT_IDS[6],
			name: t("productSuite.6.name"),
			tag: t("productTags.ticket"),
			icon: "confirmation_number",
			who: ["promoter", "talent"],
			desc: t("productSuite.6.desc"),
			highlight: false,
		},
		{
			productId: INSURANCE_PRODUCT_IDS[7],
			name: t("productSuite.7.name"),
			tag: t("productTags.sponsor"),
			icon: "star",
			who: ["promoter"],
			desc: t("productSuite.7.desc"),
			highlight: false,
		},
		{
			productId: INSURANCE_PRODUCT_IDS[8],
			name: t("productSuite.8.name"),
			tag: t("productTags.compliance"),
			icon: "fact_check",
			who: ["promoter", "vendor", "workforce", "talent"],
			desc: t("productSuite.8.desc"),
			highlight: false,
		},
		{
			productId: INSURANCE_PRODUCT_IDS[9],
			name: t("productSuite.9.name"),
			tag: t("productTags.data"),
			icon: "analytics",
			who: ["promoter"],
			desc: t("productSuite.9.desc"),
			highlight: false,
		},
	];
