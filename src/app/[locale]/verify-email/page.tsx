							...
							<div className="flex gap-2 justify-between">
								{digits.map((digit, i) => (
									<input
										...
										className="w-12 h-14 text-center text-xl font-semibold bg-surface-container-low border border-outline-variant/30 rounded-xl text-on-surface focus:outline-none focus:ring-2 focus:ring-[#FF5A2E]/30 focus:border-[#FF5A2E] transition-all disabled:opacity-60"
									/>
								))}
							</div>
						</div>
