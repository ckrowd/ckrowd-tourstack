									...
									{step === 2 && (
										<div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
											...
											<div className="mt-4 divide-y divide-slate-100 rounded-2xl bg-white p-4 shadow-sm">
												<ReviewRow label={t('review.artist')} value={selectedOpportunityTitle} />
												<ReviewRow label={t('review.markets')} value={artist.markets ?? undefined} />
												<ReviewRow label={t('review.applicant')} value={form.name} />
												<ReviewRow label={t('review.email')} value={form.email} />
												<ReviewRow label={t('review.company')} value={form.company} />
												<ReviewRow label={t('review.city')} value={form.city} />
												<ReviewRow label={t('review.audience')} value={form.audience} />
												<ReviewRow label={t('review.notes')} value={form.notes} />
												<ReviewRow
													label={t('review.estimatedAudience')}
													value={estimatedAudience > 0
