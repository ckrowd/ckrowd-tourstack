		...
		<div>
			...
			{isLoading ? (
				...
				<div className="flex flex-col items-center justify-center py-24 text-center">
					<span className="material-symbols-outlined text-5xl mb-4 text-on-surface-variant">send</span>
					<p className="font-semibold text-lg text-on-surface">{t("noPitches")}</p>
					...
					{pitches.map((pitch) => {
						...
						return (
							...
							>
								<div className="flex items-start gap-4 flex-wrap">
									...
									<div className="flex-1 min-w-0">
										...
										<p className="text-sm font-semibold text-on-surface-variant mt-0.5">
											<span className="material-symbols-outlined text-xs text-on-surface-variant mr-1 align-middle">
												music_note
											</span>
									...
									<div className="flex flex-col items-end gap-2 shrink-0">
										<span
											className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold ${STATUS_STYLES[status] ?? STATUS_STYLES.pending}`}
										>
								...
								{/* Actions */}
								<div className="flex items-center gap-3 mt-4 pt-3 border-t border-outline-variant flex-wrap">
