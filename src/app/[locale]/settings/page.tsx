			...
			>
				<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
					<Field
						...
						id="v-name"
						defaultValue="Alliance Française Accra"
					/>
					<Field
						label={t("venueDetails.fields.type")}
						id="v-type"
						defaultValue="Indoor Theatre"
					/>
					<Field
					...
					<Field
						...
						id="v-address"
						defaultValue="Alliance Française, Liberation Road"
					/>
				...
				<div className="space-y-3">
					<div className="flex items-center gap-4 p-5 bg-surface-container-low rounded-xl border border-outline-variant/20">
						...
						<div className="flex-1">
							...
							<p className="text-xs text-on-surface-variant">
								{t("paymentMethod.expires")} 08 / 2026
							</p>
						</div>
