...
function reviewRow(label: string, value: string | boolean | string[] | undefined) {
      ...
      <div className="bg-surface text-on-surface min-h-screen flex">
        ...
        <main className="flex-1 min-h-screen overflow-y-auto bg-surface-container-low p-6 md:p-12 flex items-center justify-center">
          <div className="text-center max-w-lg">
            <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 bg-[#FF5A30]/10">
              <span
            ...
            <p className="text-on-surface-variant mb-8">
              Your promoter intake form has been submitted. The Ckrowd team will review
              your application and respond within 48 hours via email or WhatsApp.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-10">
            ...
            <p className="text-on-surface-variant">
              Apply to become a verified Ckrowd promoter and unlock access to Pan-African tour stops,
              artist partnerships, and financing support.
            </p>
          </header>
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-8 md:p-10 shadow-sm border border-outline-variant/10">
            ...
            >
              ...
              {step === 0 && (
                <div className="space-y-8">
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-xl font-bold font-(family-name:--font-manrope)">Basic Information</h3>
                  </div>
              ...
              {step === 1 && (
                <div className="space-y-10">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="material-symbols-outlined text-[#FF5A30]">workspace_premium</span>
                    <h3 className="text-xl font-bold font-(family-name:--font-manrope)">Experience Snapshot</h3>
                  </div>

                  <div className="space-y-8">
                    <div>
                      <Label htmlFor="years-exp">Years of Promoting Experience</Label>
                    ...
                    <div>
                      <Label htmlFor="events-year">Events Organized in the Last 12 Months</Label>
                      <div className="relative mt-1.5">
                        <select
                          id="events-year"
                          className={selectClass}
                          value={form.eventsLastYear}
                          onChange={(e) => set("eventsLastYear", e.target.value)}
                        >
                          <option value="">-- Select range --</option>
                          <option>0–2</option>
                          <option>3–5</option>
                    ...
                    <div>
                      <Label htmlFor="crowd-size">Largest Crowd Successfully Hosted</Label>
                      <div className="relative mt-1.5">
                        <select
                          id="crowd-size"
                          className={selectClass}
                          value={form.largestCrowd}
                          onChange={(e) => set("largestCrowd", e.target.value)}
                        >
                          <option value="">-- Select range --</option>
                    ...
                    <div>
                      <p className="block text-sm font-semibold text-on-surface-variant mb-3">
                        Artist Level Worked With <span className="font-normal italic">(select all that apply)</span>
                      </p>
                      <CheckGroup
                        name="artist-level"
                        options={["Emerging/Local", "Mid-tier National", "Top-tier National", "International"]}
              ...
              {step === 2 && (
                <div className="space-y-10">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="material-symbols-outlined text-[#FF5A30]">lock_open</span>
                  ...
                  <p className="text-sm text-on-surface-variant -mt-6">
                    The Aya Pilot is reserved for promoters with demonstrated large-venue experience.
                    This gate check determines your eligibility tier.
                  </p>

                  <div className="bg-surface-container-low rounded-2xl p-6 border border-outline-variant/10">
                    <p className="text-sm font-semibold text-on-surface mb-4">
                      Have you ever executed an event in a 10,000+ capacity venue?
                    </p>
                    <CheckGroup
                      name="large-venue"
                      options={["Yes", "No"]}
                  ...
                  {form.hostedLargeVenue === "Yes" && (
                    <div className="space-y-6">
                        ...
                        {form.proofFileName ? (
                          <div className="flex items-center justify-center gap-3">
                            ...
                            <div className="text-left">
                              <p className="font-bold text-on-surface">{form.proofFileName}</p>
                          ...
                          <>
                            ...
                            <p className="font-bold text-on-surface mb-1">Upload Proof of Large Venue Event</p>
                            <p className="text-sm text-on-surface-variant">
                              Flyer, ticket link screenshot, video, or media coverage
                            </p>
                      ...
                      <div className="flex items-start gap-3 bg-amber-50 rounded-xl p-4 border border-amber-200">
                        ...
                        <div>
                          <p className="text-sm font-bold text-amber-800">Aya Pilot Tier Unlocked</p>
                          <p className="text-xs text-amber-700 mt-0.5">
                            Your profile will be flagged for priority review and access to Aya Pilot features,
                            including premium tour allocations and dedicated support.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {form.hostedLargeVenue === "No" && (
                    <div className="flex items-start gap-3 bg-surface-container-low rounded-xl p-4 border border-outline-variant/20">
                      ...
                      <div>
                        <p className="text-sm font-bold text-on-surface">Standard Tier</p>
                        <p className="text-xs text-on-surface-variant mt-0.5">
                          You&apos;ll be reviewed for our standard promoter program. As you build your track record
                          with Ckrowd, you can unlock higher tiers.
                        </p>
                      </div>
                    </div>
                  )}
              ...
              {step === 3 && (
                <div className="space-y-10">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-xl font-bold font-(family-name:--font-manrope)">Credibility Signals</h3>
                  </div>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      {[
                        { id: "instagram", label: "Instagram", icon: "photo_camera", field: "instagram" as const, placeholder: "https://instagram.com/your_handle" },
                        { id: "twitter", label: "Twitter / X", icon: "tag", field: "twitter" as const, placeholder: "https://x.com/your_handle" },
                        { id: "youtube", label: "YouTube / TikTok", icon: "play_circle", field: "youtube" as const, placeholder: "https://youtube.com/your_channel" },
                        { id: "ticket-links", label: "Ticketing Links", icon: "confirmation_number", field: "ticketLinks" as const, placeholder: "https://tickets.example.com/your_event" },
                      ].map((item) => (
                        <div key={item.id} className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-surface-container-highest border-none rounded-xl focus:ring-2 focus:ring-[#FF5A30] transition-all text-on-surface outline-none text-sm"
                  ...
                  <section>
                    ...
                    <div className="space-y-3">
                      {[
                        { id: "biz-reg", label: "Registered Business", field: "hasRegisteredBusiness" as const },
                        { id: "bank-acct", label: "Active Bank Account", field: "hasActiveBankAccount" as const },
                        { id: "sponsors", label: "Existing Brand Sponsors", field: "hasBrandSponsors" as const },
                      ].map((item) => (
                        <label
                          key={item.id}
                          htmlFor={item.id}
              ...
              {step === 4 && (
                <div className="space-y-10">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="material-symbols-outlined text-[#FF5A30]">flag</span>
                    <h3 className="text-xl font-bold font-(family-name:--font-manrope)">Intent &amp; Review</h3>
                  </div>

                  <section>
                    <p className="text-sm font-semibold text-on-surface-variant mb-3">
                      What are you looking for? <span className="font-normal italic">(select all that apply)</span>
                    </p>
                    <CheckGroup
                      name="intent"
                      options={["Funding", "Tour support", "Artist partnerships", "Training", "All of the above"]}
                      value={form.intent}
                  ...
                  <section>
                    <Label htmlFor="budget-range">Estimated Budget for Your Next Event / Tour</Label>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-1.5">
                      {["<$10K", "$10K–50K", "$50K–150K", "$150K+"].map((opt) => (
                        <button
                          key={opt}
                          type="button"
                  ...
                  <div className="bg-surface-container-low rounded-2xl p-6 border border-outline-variant/10 space-y-1">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-bold text-on-surface font-(family-name:--font-manrope)">Application Summary</h4>
                      {isAyaEligible && (
                    ...
                    {reviewRow("Location", form.cityCountry || "Not provided")}
                    {reviewRow("Experience", form.yearsExperience || "Not selected")}
                    {reviewRow("Events (12 mo.)", form.eventsLastYear || "Not selected")}
                    {reviewRow("Largest Crowd", form.largestCrowd || "Not selected")}
                    {reviewRow("Artist Tiers", form.artistLevel)}
                    {reviewRow("Large Venue (10K+)", form.hostedLargeVenue || "Not answered")}
                    {reviewRow("Looking For", form.intent)}
                    {reviewRow("Budget Range", form.estimatedBudget || "Not selected")}
                    {(form.hasRegisteredBusiness || form.hasActiveBankAccount || form.hasBrandSponsors) && (
                      <div className="flex items-start gap-4 py-3 border-b border-outline-variant/10 last:border-none">
                        <span className="text-xs font-bold uppercase tracking-wider text-on-surface-variant w-44 shrink-0 mt-0.5">
                          Credentials
                        </span>
                        <span className="text-sm font-semibold text-on-surface">
                          {[
                            form.hasRegisteredBusiness && "Registered Business",
                            form.hasActiveBankAccount && "Active Bank Account",
                  ...
                  <div className="bg-surface-container-low rounded-2xl p-5 border border-outline-variant/10">
                    <p className="text-sm text-on-surface-variant leading-relaxed">
                      By submitting this application, you confirm all information is accurate and you have
                      authority to represent your organisation. Your data is handled securely and shared only
                      with the Ckrowd team for review purposes.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-[#FF5A30]/10 flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-[#FF5A30]">lightbulb</span>
                </div>
                <div>
                  <h5 className="font-bold text-on-surface mb-1">Strong Applications</h5>
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    Promoters with verifiable past events, registered businesses, and
                    clear intent score highest in our review process.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-secondary-container flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-on-secondary-container">shield</span>
                </div>
                <div>
                  <h5 className="font-bold text-on-surface mb-1">Secure &amp; Confidential</h5>
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    Your data is encrypted and only shared with the Ckrowd team
                    as part of the review and onboarding process.
                  </p>
                </div>
              </div>
            </div>
