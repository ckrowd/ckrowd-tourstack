					...
					<div className="mx-auto max-w-5xl space-y-8">
						<header>
							...
							<p className="text-on-surface-variant font-medium">
								Create and manage secure onboarding links for services, workforce,
								and artist management partners.
							</p>
						</header>
							...
							>
								...
								<div className="md:col-span-2">
									...
									<input
										...
										placeholder="e.g. June Vendor Wave"
						...
						<section className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm border border-outline-variant/10">
							...
							{linksQuery.isLoading ? (
								<p className="text-sm text-on-surface-variant">Loading links...</p>
							) : !linksQuery.data?.success ? (
								<p className="text-sm text-rose-700">
									{linksQuery.data?.error ?? "Unable to load links."}
								</p>
							) : links.length === 0 ? (
								<p className="text-sm text-on-surface-variant">No links created yet.</p>
							) : (
										...
										>
											<div className="min-w-0">
												...
												<p className="text-xs text-on-surface-variant mt-1">
													{String(link.category)} · {link.is_active ? "active" : "inactive"}
												</p>
											</div>
