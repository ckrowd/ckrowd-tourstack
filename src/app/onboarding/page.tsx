	...
	return (
		<div className="space-y-6">
			...
			<p className="text-sm text-on-surface-variant">
				Choose the category that best describes the stakeholder you are
				onboarding. The form fields will adapt to your selection.
			</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div className="md:col-span-2">
						...
						<input
							id="sp-company"
							type="text"
							placeholder="e.g. Lagos Sound Systems Ltd"
			...
			<div className="space-y-8">
				...
				<div>
					<Label htmlFor="sp-certs" optional>
						Certifications, Licenses, or Affiliations
					</Label>
					<textarea
						id="sp-certs"
						rows={2}
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div className="md:col-span-2">
						...
						<input
							id="am-company"
							type="text"
							placeholder="e.g. Afrobeats Global Management"
							className={inputClass}
							required
							value={form.companyName}
							onChange={(e) => setField("companyName", e.target.value)}
					...
					<div>
						...
						<input
							id="am-website"
							type="url"
							placeholder="https://yourmgmt.com"
							className={inputClass}
							value={form.website}
							onChange={(e) => setField("website", e.target.value)}
						/>
			...
			<div className="space-y-8">
				...
				<div>
					...
					<input
						id="am-genres"
						type="text"
						placeholder="e.g. Afrobeats, Hip-Hop, Afro-Soul, Highlife"
						className={inputClass}
						required
						value={form.genres}
				...
				<div>
					<Label htmlFor="am-collabs" optional>
						Past Tour Collaborations or Markets Toured
					</Label>
					<textarea
						id="am-collabs"
						rows={3}
					...
					<main className="flex-1 flex items-center justify-center bg-surface-container-low p-8">
						<div className="text-center max-w-md">
							...
							<p className="text-on-surface-variant mb-8">
								The entry has been saved to the directory. You can view it under
								the Directory tab.
							</p>
											...
											<div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-start gap-3">
												...
												<div>
													...
													<p className="text-xs text-blue-700">
														Crew members register via the dedicated Workforce
														portal which includes the WCS (Workforce Capability
														Score) system.
													</p>
													<Link
														href="/workforce"
