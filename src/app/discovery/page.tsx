        ...
        <section className="bg-surface-container-low rounded-2xl p-4 md:p-6 flex flex-wrap items-end gap-4">
          <div className="flex-1 min-w-45">
            ...
            <div className="relative">
              <select id="filter-genre" className="w-full bg-surface-container-lowest border-none rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-[#FF5A30]/20 appearance-none outline-none">
          ...
          <div className="flex-1 min-w-45">
            ...
            <div className="relative">
              <select id="filter-window" className="w-full bg-surface-container-lowest border-none rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-[#FF5A30]/20 appearance-none outline-none">
          ...
          <div className="flex-1 min-w-45">
            ...
            <div className="relative">
              <select id="filter-fee" className="w-full bg-surface-container-lowest border-none rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-[#FF5A30]/20 appearance-none outline-none">
          ...
          <div className="flex-1 min-w-45">
            ...
            <div className="relative">
              <select id="filter-region" className="w-full bg-surface-container-lowest border-none rounded-xl py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-[#FF5A30]/20 appearance-none outline-none">
          ...
          <div className="lg:col-span-9">
            <div className="flex items-center justify-between mb-8">
              <h2 className="font-(family-name:--font-manrope) text-2xl font-bold">
                ...
                <span className="text-on-surface-variant font-normal text-lg">(6)</span>
              </h2>
