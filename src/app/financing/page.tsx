...
const partners = [
  { name: "AfriCapital Partners", region: "Pan-Africa", focus: "Event Finance" },
  { name: "Lagos Growth Fund", region: "West Africa", focus: "SME & Culture" },
  { name: "East Africa Ventures", region: "East Africa", focus: "Creative Economy" },
  { name: "Rand Music Finance", region: "Southern Africa", focus: "Live Entertainment" },
];
